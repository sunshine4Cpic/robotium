...
class WebElementCreator {
	...
	private void setLocation(WebElement webElement, WebView webView, int x, int y, int width, int height ){
		...
		int upperLeftCornerX=(int) (locationOfWebViewXY[0] + x * scale);
		int upperLeftCornerY=(int) (locationOfWebViewXY[1] + y * scale);
		int lowerRightCornerX=(int)(locationOfWebViewXY[0] + (x + width) * scale);
		int lowerRightCornerY=(int)(locationOfWebViewXY[0] + (x + height) * scale);
		
		
		webElement.setLocationX(locationX);
		webElement.setLocationY(locationY);
		
		webElement.setUpperLeftCornerX(upperLeftCornerX);
		webElement.setUpperLeftCornerY(upperLeftCornerY);
		webElement.setLowerRightCornerX(lowerRightCornerX);
		webElement.setLowerRightCornerY(lowerRightCornerY);
	}
