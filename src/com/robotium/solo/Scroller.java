...
//			Assert.fail("AbsListView is null!");
	...
	public void scrollToSide(Side side, float scrollPosition, int stepCount) {
		...
		if (side == Side.LEFT)
			...
			drag(screenWidth/2, screenWidth/2, screenHeight/2, 50, stepCount);
		else if (side == Side.DOWN)
			drag(screenWidth/2, screenWidth/2, screenHeight/2, screenHeight-50, stepCount);
	}
